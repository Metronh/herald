...
public class User
{
    ...
    [Column("first_name")][MaxLength(50)][Name("first_name")] public required string FirstName { get; init; }
    [Column("last_name")][MaxLength(50)][Name("last_name")] public required string LastName { get; init; }
