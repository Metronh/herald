...
public class DeactivateAccountRequestValidatorTests
{
    ...
    [Fact]
    public async Task DeactivateAccountRequest_CorrectInput_Validates()
    {
        // Arrange
        ...
        // Act
        var result = await _deactivateAccountRequestValidator.ValidateAsync(request);
    ...
    [InlineData("A")]
    [InlineData("")]
    public async Task DeactivateAccountRequest_IncorrectUsername_Fails(string username)
    {
        // Arrange
        var request = new DeactivateAccountRequest
        {
    ...
    [InlineData("A")]
    [InlineData("")]
    public async Task DeactivateAccountRequest_IncorrectPassword_Fails(string password)
    {
        // Arrange
        var request = new DeactivateAccountRequest
        {
